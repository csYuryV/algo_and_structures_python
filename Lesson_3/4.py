...
list_of_unique_values = sorted(set(list_of_random_integers))
...
print(
    list_of_unique_values[value_with_maximum_occurrence_index],
    maximum_number_of_occurrences_of_a_value)
